              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    height: 110,
                    decoration: const BoxDecoration(color: liWhite, boxShadow: [
                      BoxShadow(
                          offset: Offset(0, 2),
                          color: liLightGrey,
                          blurRadius: 5,
                          ...
                          TextFormField(
                            ...
                            onTap: () {
                              _postBodyController.addListener(() {
                                ...
                                } else if (_postBodyController.text.length <
                                    1) {
                                  setState(() {});
  ...
  _switchWidget({String? title, IconData? prefixIcon, IconData? suffixIcon}) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          border: Border.all(width: 1, color: liMediumGrey)),
      child: Row(
        children: [
          Icon(
            prefixIcon,
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return FocusScope(
          ...
          child: Container(
            decoration: BoxDecoration(color: liWhite, boxShadow: [
              BoxShadow(
      ...
      children: [
        ...
        Text(
          ...
          style: const TextStyle(
              fontSize: 16, color: liMediumGrey, fontWeight: FontWeight.bold),
        )
      ],
    );
  }
